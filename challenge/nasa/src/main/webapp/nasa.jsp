    ...
    %>
		...
		<form action="nasa.jsp" method = "POST">
			 ...
			 <input type="DATE" id="DATE" name="DATE" value ="<%out.print(request.getParameter("DATE"));%>">
				<% }%>
				<input type="submit" value="Search by date" style="background-color: #1BA098; font-size: 19px; animation: rotating 2s 0.25s linear infinite;">
		</form>
									...
									<div class="d-block w-100px" style="height: 900px; background-color: #051622; color: #DEB992; text-align: center; font-size: 5px;">
										...
										<form action="nasa.jsp" method="POST">
											...
											<%if (Nasa.pics_likes.get(Nasa.pics.get(i).date)) {%>
												<input type="submit" class="btn btn-primary btn-lg" value="Unlike" style="margin-top: 1%; background-color: #1BA098; font-size: 24px; padding: 15px 62px;">
											<% } else { %>
												<div class="d-grid gap-2 d-md-flex justify-content-md-center">
													<input type="submit" class="btn btn-primary btn-lg" value="Like" style="margin-top: 1%; background-color: #1BA098; font-size: 24px; padding: 15px 62px;">
												</div>
											<% } %>
										</form>
									</div>
